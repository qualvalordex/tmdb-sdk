...
import { MovieGetDetailsDTO, MovieGetRecommendationsDTO, MovieGetAlternativeTitlesDTO } from "./types"
...
export class Movie extends TMDBRequest {
    ...
    public async alternativeTypes(params: MovieGetAlternativeTitlesDTO) {
